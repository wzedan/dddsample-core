...
public class HandlingActivity implements ValueObject<HandlingActivity> {
  ...
  // TODO make HandlingActivity a part of HandlingEvent too? There is some overlap. 
    ...
    @ManyToOne
    @JoinColumn(name = "next_expected_location_id", foreignKey = @ForeignKey(name = "arrival_location_fk"))
    private Location location;

    @ManyToOne
    @JoinColumn(name = "next_expected_voyage_id", foreignKey = @ForeignKey(name = "departure_location_fk"))
